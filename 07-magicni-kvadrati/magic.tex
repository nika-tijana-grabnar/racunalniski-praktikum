...
%\newenvironment{magic}[1]{
   %\begin{table}[!ht]
      %\centering
      %\large
      %caption{#2} - drugi argument
      %label{#3} - tretji argument
...
\begin{table}
   \centering
   \title{Število različnih normalnih magičnih kvadratov}
   \label{table:stevila}
   \begin{tabular}{lcccccc} \toprule
      & \multicolumn{5}{c}{točna vrednost} & približek \\\midrule %ali \hline
      red &1 &2 &3 &4 &5 &6 \\
